...
Cloudflare offers at-cost domain registration through [Cloudflare Registrar](/registrar/). Every domain acquired through Cloudflare Registrar must also use Cloudflare as primary authoritative DNS.
