...
1.  Invoke the [Get a zone ruleset](/api/resources/rulesets/methods/get/) operation to obtain a list of rules in the Cloudflare Managed Ruleset (ruleset ID <RuleID id="efb7b8c949ac4650a09736fc376e9aee" />).<br/>
    You can get the managed ruleset details using the account-level endpoint ([Get an account ruleset](/api/operations/getAccountRuleset)) or the zone-level endpoint ([Get a zone ruleset](/api/resources/rulesets/methods/get/)).
